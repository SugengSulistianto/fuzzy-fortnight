        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="{{ asset( 'themes/sansekertta/assets//img/slider.jpg') }}" class="d-block w-100" alt="slider">
            </div>
            <div class="carousel-item">
              <img src="{{ asset( 'themes/sansekertta/assets//img/slider1.jpg') }}" class="d-block w-100" alt="slider1">
            </div>
          </div>
