...
<div class="leftside-menu menuitem-active">
            ...
            <!-- Sidebar -->
            <div class="h-100 show simplebar-scrollable-y" id="leftside-menu-container" data-simplebar="init"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: 100%; overflow: hidden scroll;"><div class="simplebar-content" style="padding: 0px;">
                <!-- Leftbar User -->
                        ...
                        <div class="collapse show" id="sidebarLayouts">
                            <ul class="side-nav-second-level">
                                ...
                                <li class="menuitem-active">
                                    <a href="layouts-hover.html" target="_blank" class="active">Hover Menu</a>
                                </li>
                                <li>
            ...
            </div></div></div></div><div class="simplebar-placeholder" style="width: 260px; height: 2030px;"></div></div><div class="simplebar-track simplebar-horizontal" style="visibility: hidden;"><div class="simplebar-scrollbar simplebar-visible" style="width: 0px; transform: translate3d(0px, 0px, 0px); display: none;"></div></div><div class="simplebar-track simplebar-vertical" style="visibility: visible;"><div class="simplebar-scrollbar" style="height: 155px; transform: translate3d(0px, 211px, 0px); display: block;"></div></div></div>
        </div>
        @endsection