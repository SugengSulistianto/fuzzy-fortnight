            ...
            <div class="col-md-6">
                <div id="product-images" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active"> <img src="{{ asset('img/sansekertavol4blkng.jpg') }}" alt="Product 1"> </div>
                        <div class="carousel-item"> <img src="{{ asset('img/sansekertavol4.jpg') }}" alt="Product 2"> </div>
                    </div> <!-- Left right -->
                    ...
                    <ol class="carousel-indicators list-inline">
                        <li class="list-inline-item active"> <a id="carousel-selector-0" class="active" data-bs-slide-to="0" data-bs-target="#product-images"> <img src="{{ asset('img/sansekertavol4blkng.jpg') }}" class="img-fluid"> </a> </li>
                        <li class="list-inline-item"> <a id="carousel-selector-1" data-bs-slide-to="1" data-bs-target="#product-images">
                                <img src="{{ asset('img/sansekertavol4.jpg') }}" class="img-fluid"> </a> </li>
                    </ol>
                </div>
            </div>
            <div class="col-md-6">
                <div class="product-detail mt-6 mt-md-0">
                    ...
                    <div class="product-select mt-3 row justify-content-start g-2 align-items-center">
                        @include ('themes.sansekertta.shared.flash')
